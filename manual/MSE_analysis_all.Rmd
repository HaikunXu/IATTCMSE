...
Check_list <- data.frame(HSnum = c(1,1,1,1,2),
                         HCR_name = c("HCR_staff_0","HCR_staff_0_Fscaler","HCR_staff","HCR_staff_Fscaler","HCR_staff_0_risk"),
                         HS_plot = c("HS_Fix","HS_Fix_tuned","HS_Fix","HS_Fix_tuned","HS_ensemble"),
                         HCR_plot = c("HCR1","HCR1","HCR2","HCR2","HCR1"))
```
