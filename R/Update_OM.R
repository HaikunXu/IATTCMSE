...
Update_OM = function(dir_OM, dir_OM_Boot, Mcycle, EM_comp_fleet) {
  ...
  data_boot <- r4ss::SS_readdat_3.30(file = paste0(dir_OM_Boot, "data_expval.ss"), verbose = FALSE)
  ...
  r4ss::SS_writedat_3.30(dat_OM, paste0(dir_OM, "BET-EPO.dat"), verbose = FALSE, overwrite = TRUE)
