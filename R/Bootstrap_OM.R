...
#' @param plot what r4ss tabs to plot
#' 
#' @author Haikun Xu 
#' @export

Bootstrap_OM = function(dir_istep, istep, dir_OM, Mcycle, seed, plot = NA) {
  ...
  r4ss::SS_plots(replist=om_out, forecastplot=T, uncertainty=F, datplot=T, plot = plot, verbose = FALSE)
