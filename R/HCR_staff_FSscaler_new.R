...
HCR_staff_FSscaler_new = function(dir_EM, istep, CurrentClosure) {
  ...
  SBR_d <- Dynamic_Bzero$SSB[nrow(Dynamic_Bzero)] / Dynamic_Bzero$SSB_nofishing[nrow(Dynamic_Bzero)] * 1.5
