...
Estimation_EM_risk = function(dir_istep, dir_EM_previous, dir_OM_Boot, R0, Mcycle, dat_name, ctl_name, ss_name, plot = FALSE, include_LF = TRUE) {
  ...
  for (m in 1:4) {
    ...
    ctl$SR_parms$INIT[1] <- R0 # adding 0.2 makes the EM more likely to converge
